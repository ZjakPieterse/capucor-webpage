...
export const FAIR_USAGE: Record<string, ServiceFairUsage> = {
  ...
  bookkeeping: {
    ...
    overage:
      'Months that run over the allowance are billed at R175 per extra 25 transactions. We measure this on the quarterly review against your rolling average, not on a single busy month.',
  },
  payroll: {
    name: 'Payroll',
